...
set key at 10.4,350 box lw 3 maxcols 1 maxrows 5 font ', 55' width 1 samplen 7 spacing 1.6

set xtics 1 offset 0, 0.2 font ', 55'
set ytics 100 offset 0.8, -0.04 font ', 55'
set grid ytics
...
#set style line 5 lt 5 lw 7 pt 75 ps 2 lc rgb "dark-cyan"
#set style line 6 lt 6 lw 7 pt 76 ps 2 lc rgb "black"
#
# draw some plots
#
plot "./tsv/down/".NAME.".tsv" \
