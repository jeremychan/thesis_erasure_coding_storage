...
writes are small updates and motivates us to build a clustered storage that
...
to improve update efficiency as caching alone may not be sufficient to achieve a
